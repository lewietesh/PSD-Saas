...
urlpatterns = [
    ...
    # path('categories/', views.ServiceCategoriesAPIView.as_view(), name='service-categories'), # Replaced by ServiceCategoryViewSet
...
# SERVICE CATEGORIES:
# GET    /api/v1/services/categories/                - List all categories (public: active only, admin: all)
# POST   /api/v1/services/categories/                - Create category (admin only)
# GET    /api/v1/services/categories/{id}/           - Get specific category (public)
# PUT    /api/v1/services/categories/{id}/           - Update category (admin only)
# PATCH  /api/v1/services/categories/{id}/           - Partial update (admin only)
# DELETE /api/v1/services/categories/{id}/           - Delete category (admin only)
# GET    /api/v1/services/categories/{id}/services/  - Get all services in category (public: active only)
# GET    /api/v1/services/categories/stats/          - Get category statistics (public)
...
# GET    /api/v1/services/category/{category}/       - Get services by specific category (public, legacy string-based)
